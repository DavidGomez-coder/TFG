            ...
            <div id="rc-theory" className="scrool_section">
                ...
                <Accordion>
                    <Accordion.Item eventKey='rc-0'>
                        ...
                        <Accordion.Body>
                            ...
                            <MathJax.Provider>
                                <MathJax.Node formula="R \cdot C \frac{\partial q(t)}{\partial t} = C \cdot \varepsilon - q(t)" />
                            </MathJax.Provider>
                            <MathJax.Provider>
                                <MathJax.Node formula="\frac{\partial q(t)}{\partial t} = \frac{C \cdot \varepsilon - q(t)}{R \cdot C}" />
                            </MathJax.Provider>
                            <MathJax.Provider>
                                <MathJax.Node formula="\frac{\partial q(t)}{C \cdot \varepsilon - q(t)} = \frac{\partial t}{R \cdot C}" />
                            </MathJax.Provider>
                            A continuación, tenemos que definir los límites de integración. En un instante inicial, es decir, para
                            <MathJax.Provider><MathJax.Node inline formula="\hspace{0.1cm} t=0" /></MathJax.Provider>, consideraremos que el condensador está completamente descargado, o lo que es lo mismo,
                            <MathJax.Provider><MathJax.Node inline formula="\hspace{0.1cm} q(0) = 0" /></MathJax.Provider>. Integramos a ambos lados:

                            <MathJax.Provider>
                                <MathJax.Node formula="\int_{0}^{q(t)} \frac{\partial q(t)}{C \cdot \varepsilon - q(t)} = \int_{0}^{t} \frac{\partial t}{R \cdot C}" />
                            </MathJax.Provider>
                            Resolvemos las integrales anteriores:
                            <MathJax.Provider>
                                <MathJax.Node formula="\left[ \ln{\left(C \cdot \varepsilon - q(t)\right)} \right]_{0}^{q(t)} = \frac{1}{R\cdot C}\left[ t \right]_{0}^{t}" />
                            </MathJax.Provider>
                            <MathJax.Provider>
                                <MathJax.Node formula="-\ln{\left( C \cdot \varepsilon - q(t) \right)} + \ln{\left( C \cdot \varepsilon \right)} = \frac{t}{R\cdot C}" />
                            </MathJax.Provider>
                            <MathJax.Provider>
                                <MathJax.Node formula="\mathcal{\huge e}^{-\ln{\left( C \cdot \varepsilon - q(t) \right)} + \ln{\left( C \cdot \varepsilon \right)}} = \mathcal{\huge e}^{\frac{t}{R\cdot C}}" />
                            </MathJax.Provider>
                            <MathJax.Provider>
                                <MathJax.Node formula="\mathcal{\huge e}^{-\ln{\left( C \cdot \varepsilon - q(t) \right) }} \cdot \mathcal{\huge e}^{\ln{\left( C \cdot \varepsilon \right)}} = \mathcal{\huge e}^{\frac{t}{R\cdot C}}" />
                            </MathJax.Provider>
                            <MathJax.Provider>
                                <MathJax.Node formula="\frac{C \cdot \varepsilon}{C \cdot \varepsilon - q(t)} = \mathcal{\huge e}^{\frac{t}{RC}}" />
                            </MathJax.Provider>
                            Despejamos <MathJax.Provider><MathJax.Node inline formula="\hspace{0.1cm} q(t)" /></MathJax.Provider>:
                            <MathJax.Provider>
                                <MathJax.Node formula="q(t) = C \varepsilon \left( 1 - \mathcal{\huge e}^{-\frac{t}{R \cdot C}}\right)" />
                            </MathJax.Provider>
                        </Accordion.Body>
                    </Accordion.Item>
                </Accordion>
                ...
                <div id="rc-on_charge_q_max">
                    <ListGroup>
                        ...
                        <ListGroup.Item>
                            <MathJax.Provider>
                                <MathJax.Node formula="Q_{max} = \lim_{t \to \infty} q(t) = \lim_{t \to \infty} C \varepsilon \left( 1 - \mathcal{\huge e}^{-\frac{t}{R \cdot C}}\right) = C \cdot \varepsilon " />
                            </MathJax.Provider>
                ...
                <MathJax.Provider><MathJax.Node inline formula="\hspace{0.1cm} \varepsilon = 0" /></MathJax.Provider>. Consideraremos para la descarga, que en el instante inicial la carga almacenada en el condensador es la máxima
                (<MathJax.Provider><MathJax.Node inline formula="\hspace{0.1cm} q(0) = C \cdot \varepsilon" /></MathJax.Provider>), que denotaremos como <MathJax.Provider><MathJax.Node inline formula="\hspace{0.1cm} q_0" /></MathJax.Provider>.
                <br />
                <br />
                Usaremos la segunda ley de Kirchhoff
                <MathJax.Provider><MathJax.Node formula="V_C(t) + V_R(t) = 0" /></MathJax.Provider>, y aplicando las definiciones correspondientes tenemos que
                <MathJax.Provider><MathJax.Node formula="\frac{q(t)}{C} + R\cdot I(t) = \frac{q(t)}{C} + R\frac{\partial q(t)}{\partial t} = 0" /></MathJax.Provider>
                Obteniendo la siguiente ecuación diferencial:
                <MathJax.Provider><MathJax.Node formula={SUST_DEFINITION3} /></MathJax.Provider>
                <br />
                <br />
                ...
                <Accordion>
                    <Accordion.Item eventKey='rc-1'>
                        ...
                        <Accordion.Body>
                            En primer lugar, lo que haremos será despejar a cada lado de la igualdad, los términos correspondientes de la ecuación diferencial obtenida:
                            <MathJax.Provider><MathJax.Node formula="\frac{-\partial t}{C \cdot R} = \frac{\partial q(t)}{q(t)}" /></MathJax.Provider>
                            Integramos a ambos lados, bajo los límites anteriores:
                            <MathJax.Provider><MathJax.Node formula="\int_{q_0}^{q(t)} \frac{-\partial t}{C \cdot R} = \int_{0}^{t} \frac{\partial q(t)}{q(t)}" /></MathJax.Provider>
                            <MathJax.Provider><MathJax.Node formula="\left[ \ln q(t) \right]_{q_0}^{q(t)} = \frac{-1}{RC}\left[ t\right]_{0}^{t}" /></MathJax.Provider>
                            <MathJax.Provider><MathJax.Node formula="\ln q(t) - \ln q_0 = \frac{-t}{RC}" /></MathJax.Provider>
                            <MathJax.Provider><MathJax.Node formula="\mathcal{\huge e}^{\ln q(t) - \ln q_0} = \mathcal{\huge e}^{\frac{-t}{RC}}" /></MathJax.Provider>
                            <MathJax.Provider><MathJax.Node formula="\mathcal{\huge e}^{\ln q(t)} \cdot \mathcal{\huge e}^{-\ln q_0} = \mathcal{\huge e}^{\frac{-t}{RC}}" /></MathJax.Provider>
                            <MathJax.Provider><MathJax.Node formula="q(t)\frac{1}{q_0} = \mathcal{\huge e}^{\frac{-t}{RC}}" /></MathJax.Provider>
                            Dónde
                            <MathJax.Provider><MathJax.Node formula="q(t) = q_0 \cdot \mathcal{\huge e}^{\frac{-t}{RC}}" /></MathJax.Provider>
                        </Accordion.Body>
                    </Accordion.Item>
                </Accordion>
                <br />
                ...
                <div id="rc-on-discharge-expressions">
                    <ListGroup>
                        <ListGroup.Item disabled>Carga del condensador</ListGroup.Item>
                        <ListGroup.Item><MathJax.Provider>
                            <MathJax.Node formula="q(t) = q_0 \cdot \mathcal{\huge e}^{\frac{-t}{RC}}" />
                        </MathJax.Provider></ListGroup.Item>
                        <ListGroup.Item disabled>Intensidad de corriente</ListGroup.Item>
                        <ListGroup.Item>
                            <MathJax.Provider>
                                <MathJax.Node formula={RCI_ON_DISCHARGE} />
                            </MathJax.Provider>
                        </ListGroup.Item>
                        <ListGroup.Item disabled>Diferencia de potencial en la resistencia</ListGroup.Item>
                        <ListGroup.Item>
                            <MathJax.Provider>
                                <MathJax.Node formula={VR_ON_DISCHARGE} />
                            </MathJax.Provider>
                        </ListGroup.Item>
                        <ListGroup.Item disabled>Diferencia de potencial en el condensador</ListGroup.Item>
                        <ListGroup.Item>
